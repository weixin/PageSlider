...
(function($) {
    ...
    var defaults = {
        ...
        onSwipeUp: function (e) {  //swipeUp 回调
        },
        onSwipeDown: function (e) {//swipeDown 回调
        },
        onSwipeLeft: function (e) {//swipeLeft 回调
        },
        onSwipeRight: function (e) {//swipeRight 回调
        },
        oninit: function (e) {     //初始化完成时的回调
        },
        onbeforechange: function (e) {  //开始切换前的回调
        },
        onchange: function (e) {   //每一屏切换完成时的回调
